...
Este artigo ensina a usar a sintaxe do [Markdown](https://en.wikipedia.org/wiki/Markdown) para adicionar formatação detalhada, tabelas e imagens às suas solicitações de aprovação.
